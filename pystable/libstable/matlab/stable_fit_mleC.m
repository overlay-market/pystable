function [pars, status]=stable_fit_mleC(data, pars_init, parametrization)
% [pars, status]=stable_fit_mleC(data, pars_init, parametrization)
% Maximum likelihood estimation of alpha-stable parameters.
%  Inputs:
...
status=calllib('libstable','stable_fit_mle',dist,data,n);
